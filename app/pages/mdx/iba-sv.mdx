...
Ånnsjön är sedan 1974 ett Ramsarområde vilket innebär att här finns, ur internationellt perspektiv, ett skyddsvärt våtmarksområde. Genom att underteckna [Ramsarkonventionen](http://ramsar.org/) har Sverige förbundit sig att skydda och bevara fågellivet i området. Ånnsjön-Storlien är dessutom ett av ca 70 IBA-områden i Sverige. IBA står för Important Bird Area, ungefär "Viktigt fågelområde", och är ett internationellt projekt som drivs av [BirdLife International](http://birdlife.org/).

<Figure caption="Information om fågelskydd. Foto Steve Dahlfors">
  <Image alt="Fågelskydd" src="/assets/images/fagelskydd_steve-dahlfors.jpg" />
</Figure>
...
- [Fågelskydd, sammanfattning](/file/iba/iba-sammanfattning.pdf 'download') (pdf)
- [Ramsar om Ånnsjön](https://rsis.ramsar.org/ris/26)
- [BirdLife Sverige](https://birdlife.se/fagelskydd/)
