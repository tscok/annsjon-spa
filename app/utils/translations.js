const translations = {
    ...
    'annual-meeting_body': {
        se:
            'Lördagen den 18 juni, kl 15.00, anordnar styrelsen i Föreningen Ånnsjöns Fågelstation digitalt årsmöte. Medlemmar i föreningen och allmänheten välkomnas att delta. Kontakta oss för länk till videomötet.',
        en:
            'The Board of Lake Ånnsjön Bird Observatory invites members and the public community to our Annual General Meeting in Handöl, 18 June 2022 at 3 pm.',
    },
    ...
    'guides_body-handol': {
        se:
            'Längs älven Handölans lopp genom Handöl sträcker sig ett lummigt, löv\u00adskogs\u00addominerat område med ett rikt fågelliv. Här hittar man bl.a. trädgårds\u00adsångare, svarthätta, härmsångare och bergfink.',
        en:
    ...
    volunteer_error_message: {
        se:
            '$1 Din ansökan kunde inte skickas på grund av tekniska problem. Vänligen skicka din ansökan till $2 eller försök igen senare. Vi beklagar besväret!',
        en:
            '$1 Your application could not be sent due to technical problems. Please consider applying to $2 or try again later. We are sorry for the inconvenience!',
    },
    volunteer_submit: {
        se: 'Skicka',
        en: 'Submit',
    ...
    volunteer_confirmation: {
        ...
        en:
            'Your application has been sent.$1We will process it and get back to you as soon as possible.',
    },
